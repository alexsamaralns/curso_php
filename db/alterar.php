...
<form method="get">
    ...
    <div class="form-group row">
        <div class="col-sm-2">
            <input class="form-control" type="text" name="codigo" value="<?= $_GET['codigo'] ?>" placeholder="Informe id">
        </div>
        <div class="col-sm-2">
            <button class="btn btn-success mb-4" href="exercicio.php?dir=db&file=alterar&codigo<?= $_GET['codigo'] ?>">Consultar</button>       
        </div>
    </div>
</form>
