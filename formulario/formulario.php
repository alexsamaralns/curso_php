...
<?php
    if(count($_POST) > 0) {
        ...
        if(!filter_var($_POST['salario'], FILTER_VALIDATE_FLOAT, $salarioConfig) && $_POST['salario'] <= 0) {
...
<form action="#" method="post">
    ...
    <div class="form-row">
        <div class="form-group col-md-6">
            ...
            <input type="number" class="form-control <?= $erros['filhos'] ? 'is-invalid' : ''?>" id="filhos" name="filhos" placeholder="Quantidade de Filhos">
            <div class="invalid-feedback">
                <?= $erros['filhos'] ?>
            </div>
        </div>
