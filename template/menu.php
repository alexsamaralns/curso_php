<nav class="modulos">
    ...
    <div class="modulo azul-escuro">
        ...
        <ul>
            ...
            <li>
                <a href="exercicio.php?dir=classes_objetos&file=const_dest">
    ...
    <div class="modulo verde-escuro">
        ...
        <ul>
            <li>
                <a href="exercicio.php?dir=repeticoes&file=laco_for">
                    Laço For
                </a>
            </li>
            <li>
                <a href="exercicio.php?dir=repeticoes&file=desafio_laco_for">
                    Desafio Laço For
                </a>
            </li>
            <li>
            ...
            <li>
                <a href="exercicio.php?dir=repeticoes&file=while_dowhile">
                    While / Do While
                </a>
            </li>
            <li>
                <a href="exercicio.php?dir=repeticoes&file=desafio_tabela1">
                    Desafio Tabela 1
                </a>
            </li>
            <li>
    ...
    <div class="modulo roxo">
        ...
        <ul>
            ...
            <li>
                <a href="exercicio.php?dir=controle&file=operadores">
